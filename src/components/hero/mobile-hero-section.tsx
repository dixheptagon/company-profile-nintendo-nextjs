...
const images = [
  {
    src: "/mobile-hero-section/mario.jpg",
    title: "Super Mario Bros.",
    description: "Join Mario on his newest adventure!",
  },
  {
    src: "/mobile-hero-section/zelda.jpg",
    title: "Zelda: Tears of the Kingdom",
    description: "Uncover the mystery of Hyrule.",
  },
  {
    src: "/mobile-hero-section/kirby.jpg",
    title: "Kirby and the Forgotten Land",
    description: "Bounce into action!",
  },
  {
    src: "/mobile-hero-section/pokemon.jpeg",
    title: "Pokemon",
    description: "Catch 'em all!",
  },
  {
    src: "/mobile-hero-section/minecraft.png",
    title: "Minecraft",
    description: "Build and explore your world!",
  },
  {
    src: "/mobile-hero-section/animalCrossing.jpg",
    title: "Animal Crossing",
    description: "Get to know your neighbors!",
  },
];

export default function MobileNintendoHero() {
  ...
  return (
    <section className="relative block h-[42.5rem] w-full overflow-hidden md:hidden">
      <Image
        layout="fill"
        src={src}
        alt={title}
